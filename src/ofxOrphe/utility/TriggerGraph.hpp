...
public:
    ...
    TriggerGraph(): history_(history_size), area_(0, 0, 600, 300),color_(ofColor::white){
...
private:
    void update(ofEventArgs&){ buffer_.push_back(0); history_.pop_front();}
    ofRectangle area_;
